...
class GroupAdmin(admin.ModelAdmin):
    list_display = ("name", "slug", "created_by_keycloak_sub", "created_at")
...
class GroupMembershipAdmin(admin.ModelAdmin):
    list_display = ("group", "member_keycloak_sub", "role", "status", "joined_at")
...
class GroupReadingAdmin(admin.ModelAdmin):
    list_display = ("title", "group", "set_by_keycloak_sub", "created_at")
    search_fields = ("title", "group__name")


@admin.register(GroupPost)
class GroupPostAdmin(admin.ModelAdmin):
    list_display = ("title", "group", "author_keycloak_sub", "created_at")
    search_fields = ("title", "group__name")


@admin.register(GroupComment)
class GroupCommentAdmin(admin.ModelAdmin):
    list_display = ("post", "author_keycloak_sub", "created_at")
